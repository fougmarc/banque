        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Mon compte <a href="espace_caissiere_liste_clients.php" class="btn btn-danger text-white" style="float:right;">Retour </a></h6>
            </div>
            <div class="card-body">
